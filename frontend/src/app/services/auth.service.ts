...
export class AuthService {
  ...
  // The AuthGateway is the only API surface the browser talks to for auth.
  // All token handling happens server-side; the browser holds only an opaque
  // HttpOnly session cookie (GavallerAuthCookie, scoped to .gavaller.com).
  // See FRONTEND_AUTH_INTEGRATION.md for the full auth contract.
  private readonly gatewayUrl = 'https://gateway.gavaller.com';
