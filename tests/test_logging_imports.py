...
def test_entrypoint_import_block_resolves_under_container_conditions(
    ...
    for stub in [
        ...
        "stores", "stores.registry", "stores.queries", "stores.browse", "stores.categories", "stores.ids", "stores.insights", "stores.offers", "stores.recommendations", "stores.semantic", "stores.embedding_text",
